                                ...
                                <div>
                                    ...
                                    @if(auth()->user()->isTeacher())
                                        @if($subjects->count() > 1)
                                            ...
                                            <p class="mt-2 text-[9px] font-bold text-text-muted uppercase tracking-widest">Pilih mapel sesuai yang diajar</p>
                                        @else
                            ...
                            <div wire:click="toggleQuestionGroup('{{ addslashes($group->title) }}', {{ $group->subject_id }})" 
                                ...
                                <div class="flex items-center gap-8">
                                    ...
                                    <div class="flex items-center gap-2.5">
                                        ...
                                        <span class="text-xs font-black uppercase tracking-widest text-slate-500 dark:text-slate-400">{{ (int) $group->total_points }} Poin</span>
                                    </div>
                                </div>
