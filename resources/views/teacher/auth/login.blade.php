...
<body class="h-full flex items-center justify-center p-4 antialiased selection:bg-emerald-100 selection:text-emerald-900">
    <div class="max-w-md w-full relative">
        ...
        <div class="relative bg-[var(--color-bg-surface)] p-8 sm:p-12 rounded-[2rem] shadow-[0_20px_60px_-15px_rgba(16,185,129,0.08)] border border-white/60">
            <div class="text-center">
                ...
                <h1 class="text-3xl font-extrabold text-[var(--color-text-main)] tracking-tight">Portal Guru</h1>
                <p class="mt-2 text-sm text-[var(--color-text-muted)] font-medium">CBT SMAIT Baitul Muslim</p>
            </div>
            
            <form class="mt-10 space-y-6" action="{{ route('teacher.login') }}" method="POST">
                @csrf
                ...
                <div class="space-y-5">
                    ...
                    <div class="space-y-2 group">
                        ...
                        <div class="relative">
                            ...
                            <input id="email" name="email" type="email" required value="{{ old('email') }}"
                                class="block w-full pl-12 pr-4 py-4 bg-gray-50/50 border border-gray-200 text-sm rounded-2xl focus:ring-4 focus:ring-emerald-500/5 focus:border-emerald-500 focus:bg-white outline-none transition-all placeholder:text-gray-400 font-medium @error('email') border-red-300 @enderror" 
                    ...
                    <div class="space-y-2 group">
                        <div class="flex items-center justify-between ml-1">
                            ...
                            <a href="#" class="text-xs font-bold text-emerald-600 hover:underline transition-colors">Lupa password?</a>
                        </div>
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-[var(--color-text-muted)] transition-colors group-focus-within:text-emerald-600">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <input id="password" name="password" type="password" required 
                                class="block w-full pl-12 pr-4 py-4 bg-gray-50/50 border border-gray-200 text-sm rounded-2xl focus:ring-4 focus:ring-emerald-500/5 focus:border-emerald-500 focus:bg-white outline-none transition-all placeholder:text-gray-400 font-medium" 
                                placeholder="••••••••">
                        </div>
                    </div>
                </div>
                ...
                <div class="flex items-center px-1">
                    <input id="remember" name="remember" type="checkbox" class="h-5 w-5 text-emerald-600 focus:ring-emerald-500/10 border-gray-300 rounded-lg cursor-pointer transition-all">
