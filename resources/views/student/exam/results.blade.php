...
<div class="container mx-auto px-6 py-8">
    ...
    <div class="bg-bg-surface dark:bg-bg-surface rounded-2xl shadow-sm border border-border-subtle dark:border-border-subtle overflow-hidden">
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-border-subtle dark:divide-border-subtle">
                <thead class="bg-gray-50/50 dark:bg-slate-800/30">
                    <tr>
                        <th class="px-6 py-3 text-left text-xs font-medium text-text-muted uppercase tracking-wider">Mata Pelajaran</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-text-muted uppercase tracking-wider">Nama Ujian</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-text-muted uppercase tracking-wider">Tanggal Selesai</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-text-muted uppercase tracking-wider">Nilai</th>
                        <th class="px-6 py-3 text-right text-xs font-medium text-text-muted uppercase tracking-wider">Aksi</th>
                    </tr>
                </thead>
                <tbody class="bg-bg-surface dark:bg-bg-surface divide-y divide-border-subtle dark:divide-border-subtle">
                    <!-- Result 1: Published -->
                    <tr class="hover:bg-gray-50/50 dark:hover:bg-slate-800/30 transition duration-150">
                        <td class="px-6 py-4 whitespace-nowrap">
                             <div class="flex items-center">
                                ...
                                <div class="text-sm font-semibold text-text-main">Bahasa Indonesia</div>
                            </div>
                        </td>
                    ...
                    <tr class="hover:bg-gray-50/50 dark:hover:bg-slate-800/30 transition duration-150">
                        <td class="px-6 py-4 whitespace-nowrap">
                             <div class="flex items-center">
                                ...
                                <div class="text-sm font-semibold text-text-main">Matematika</div>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-text-muted">
                     ...
                     <tr class="hover:bg-gray-50/50 dark:hover:bg-slate-800/30 transition duration-150">
                        <td class="px-6 py-4 whitespace-nowrap">
                             <div class="flex items-center">
                                ...
                                <div class="text-sm font-semibold text-text-main">Kimia</div>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-text-muted">
                            Kuis Termokimia
