        ...
        <div class="flex flex-col bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden transform transition duration-500 hover:scale-105">
            ...
            <div class="p-6 flex-1 flex flex-col">
                ...
                <div class="mt-auto">
                    ...
                    <a href="{{ route('student.exam.start', ['id' => 1]) }}" class="block w-full text-center bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white font-bold py-2 px-4 rounded-lg shadow-md hover:shadow-lg transition transform hover:-translate-y-0.5 uppercase tracking-wider text-sm">
                        Mulai Kerjakan
                    </a>
                </div>
            </div>
