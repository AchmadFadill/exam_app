<aside 
    ...
    class="fixed inset-y-0 left-0 z-30 w-64 bg-primary text-white border-r border-primary/20 shadow-lg md:shadow-none transition-transform duration-300 ease-in-out md:translate-x-0 md:relative md:block"
>
    <div class="h-full flex flex-col relative">
        <!-- Logo -->
        <div class="hidden md:flex flex-col items-center justify-center h-24 border-b border-primary/10 bg-primary/20">
        ...
        <div class="p-4 border-t border-primary/10 bg-primary/20 space-y-3">
            ...
            <form method="POST" action="{{ route('logout') }}" class="w-full">
                @csrf
                <button type="submit" class="w-full flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-semibold text-red-200 bg-red-600/20 hover:bg-red-600/40 rounded-xl transition-all duration-200 border border-red-500/20 hover:border-red-500/40 active:scale-[0.98]">
