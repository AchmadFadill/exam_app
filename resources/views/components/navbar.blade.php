    ...
    <div class="flex items-center gap-6">
        ...
        <div class="relative pl-6 border-l border-border-main">
            ...
            >
                ...
                <div class="py-1">
                    <a href="#" class="flex items-center gap-3 px-4 py-2.5 text-xs text-text-muted hover:bg-primary/5 hover:text-primary transition-all duration-200 italic font-medium">
