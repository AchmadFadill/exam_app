...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 border-l-4 border-primary">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-2xl font-bold text-gray-800">452</h3>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 border-l-4 border-secondary">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-gray-500 mb-1">Guru Aktif</p>
                    <h3 class="text-2xl font-bold text-gray-800">34</h3>
                </div>
                <div class="p-3 bg-amber-50 rounded-full text-secondary">
                     <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 border-l-4 border-green-500">
             <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-gray-500 mb-1">Ujian Selesai</p>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 border-l-4 border-red-500">
             <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-gray-500 mb-1">Sedang Ujian</p>
                    <h3 class="text-2xl font-bold text-gray-800">2 Kelas</h3>
                </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 bg-white rounded-xl shadow-sm border border-gray-100">
            <div class="p-6 border-b border-gray-100 flex justify-between items-center">
                <h3 class="font-bold text-gray-800">Monitoring Ujian (Live)</h3>
                <span class="px-3 py-1 bg-red-100 text-red-600 rounded-full text-xs font-semibold">Live Updates</span>
            </div>
            <div class="p-6">
                <div class="space-y-4">
                    <!-- Ujian Item 1 -->
                ...
                <div class="mt-6">
                    ...
                    <div class="space-y-2">
                        <div class="flex items-start p-2 hover:bg-red-50 rounded transition-colors">
                        ...
                        <div class="flex items-start p-2 hover:bg-amber-50 rounded transition-colors">
