        ...
        <x-card class="relative overflow-hidden group hover:border-primary/40">
            <div class="absolute top-0 right-0 p-5 opacity-0 group-hover:opacity-100 transition-all translate-x-2 group-hover:translate-x-0">
                <div class="flex gap-2">
                    <button wire:click="openEditModal({{ $class['id'] }})" class="p-2.5 bg-bg-surface dark:bg-slate-800 shadow-xl border border-border-main dark:border-slate-700 rounded-xl text-primary hover:bg-primary hover:text-white hover:-translate-y-1 hover:shadow-2xl active:translate-y-0 transition-all duration-300">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" /></svg>
                    </button>
                    <button wire:click="openDeleteModal({{ $class['id'] }})" class="p-2.5 bg-bg-surface dark:bg-slate-800 shadow-xl border border-border-main dark:border-slate-700 rounded-xl text-red-600 hover:bg-red-600 hover:text-white hover:-translate-y-1 hover:shadow-2xl active:translate-y-0 transition-all duration-300">
