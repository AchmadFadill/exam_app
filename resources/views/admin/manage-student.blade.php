<div>
            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-gray-50">
                    ...
                    <tr class="hover:bg-gray-50/50 dark:hover:bg-slate-800/30 transition-all group">
                        ...
                        <td class="px-8 py-5">
                            <div class="flex items-center gap-4">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <div class="text-[10px] font-black text-text-muted uppercase tracking-widest opacity-40">NIS: {{ $student->nis }}</div>
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="px-8 py-5 text-sm font-bold text-text-muted lowercase">{{ $student->user->email }}</td>
                        <td class="px-8 py-5 text-right">
                            <div class="flex justify-end gap-3 opacity-40 group-hover:opacity-100 transition-opacity">
                                <button wire:click="openResetPasswordModal({{ $student->id }})" class="p-2.5 text-amber-600 hover:bg-amber-50 dark:hover:bg-amber-500/10 rounded-xl transition-all" title="Reset Password">
                                ...
                                <button wire:click="openEditModal({{ $student->id }})" class="p-2.5 text-primary hover:bg-blue-50 dark:hover:bg-primary/10 rounded-xl transition-all" title="Edit">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                    </svg>
                                </button>
                                <button wire:click="openDeleteModal({{ $student->id }})" class="p-2.5 text-red-600 hover:bg-red-50 dark:hover:bg-red-500/10 rounded-xl transition-all" title="Hapus">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    @empty
                    <tr>
                        <td colspan="5" class="px-8 py-20 text-center text-text-muted font-bold italic opacity-60">Tidak ada data koleksi siswa ditemukan.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <div class="relative bg-bg-surface dark:bg-slate-900 rounded-[2.5rem] shadow-2xl w-full max-w-lg overflow-hidden transform transition-all border border-white/5">
            ...
            <div class="p-10 space-y-8">
                ...
                <div>
                    <label class="block text-xs font-black text-text-main mb-3 uppercase tracking-widest opacity-70">Rombongan Belajar (Kelas)</label>
    ...
    <div class="fixed bottom-10 left-1/2 transform -translate-x-1/2 bg-slate-900 dark:bg-slate-800 px-10 py-5 rounded-[2rem] shadow-2xl border border-white/10 flex items-center gap-10 z-40 animate-bounce-in ring-4 ring-primary/20">
        ...
        <button wire:click="openBulkClassModal" class="group flex items-center gap-3 text-xs font-black text-white px-4 py-2 rounded-xl hover:bg-primary/10 hover:text-primary transition-all uppercase tracking-widest">
