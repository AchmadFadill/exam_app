<x-app-layout :title="$title ?? 'Administrator'">
    ...
    <x-slot name="sidebar">
        <x-sidebar>
            ...
            <div class="px-4 py-2 text-xs uppercase text-blue-300 font-semibold mt-4">Pengguna</div>
            ...
            <x-sidebar-link href="{{ route('admin.password-requests') }}" :active="request()->routeIs('admin.password-requests')">
                 <x-slot name="icon">
            ...
            <!-- Sistem -->
            <div class="px-4 py-2 text-xs uppercase text-blue-300 font-semibold mt-4">Sistem</div>
