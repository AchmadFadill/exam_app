    ...
    <div x-data="{ show: @entangle('isOpen') }" 
        ...
        <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            <div x-show="show" 
                 ...
                 @click="show = false; $wire.closeQuestionModal()"></div>
            ...
            <div x-show="show" 
                ...
                <div class="px-8 pt-8 pb-6">
                    <div class="flex justify-between items-center mb-8">
                        ...
                        <button wire:click="closeQuestionModal" class="p-2 rounded-xl hover:bg-gray-100 dark:hover:bg-slate-800 text-gray-400 hover:text-primary transition-all">
                         ...
                         <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                             ...
                             <div class="space-y-6">
                                <div>
                                    ...
                                    <input type="text" wire:model="questionForm.title" class="w-full px-6 py-4 bg-gray-100/50 dark:bg-slate-800 border border-border-main dark:border-border-main rounded-2xl focus:ring-4 focus:ring-primary/10 focus:border-primary outline-none transition-all font-bold tracking-tight shadow-inner" placeholder="Contoh: UTS Matematika, Bab Aljabar">
                                ...
                                <div>
                                    ...
                                    <div class="relative group">
                                        <select wire:model="questionForm.subject_id" class="w-full px-6 py-4 bg-gray-100/50 dark:bg-slate-800 border border-border-main dark:border-border-main rounded-2xl focus:ring-4 focus:ring-primary/10 focus:border-primary outline-none transition-all font-bold appearance-none bg-no-repeat bg-[right_1.5rem_center] bg-[length:1em_1em] shadow-inner" style="background-image: url('data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 fill=%22none%22 viewBox=%220 0 24 24%22 stroke=%22currentColor%22%3E%3Cpath stroke-linecap=%22round%22 stroke-linejoin=%22round%22 stroke-width=%222.5%22 d=%22M19 9l-7 7-7-7%22 /%3E%3C/svg%3E')">
                             ...
                             <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="number" wire:model="questionForm.score" class="w-full px-6 py-4 bg-gray-100/50 dark:bg-slate-800 border border-border-main dark:border-border-main rounded-2xl focus:ring-4 focus:ring-primary/10 focus:border-primary outline-none transition-all font-bold shadow-inner" placeholder="10">
                ...
                <div class="bg-gray-50 dark:bg-slate-800/50 px-8 py-6 flex flex-col-reverse sm:flex-row sm:justify-end gap-3 border-t border-gray-100 dark:border-slate-800">
                    ...
                    <button type="button" wire:click="save" class="w-full sm:w-auto px-8 py-3.5 bg-primary text-white rounded-xl text-xs font-black uppercase tracking-widest hover:bg-blue-600 transition-all shadow-lg shadow-primary/30 transform active:scale-95">
                        {{ $isEdit ? 'Dperbarui Soal' : 'Simpan Soal' }}
                    </button>
                </div>
            </div>
        </div>
