            ...
            <x-card title="Foto Profil">
                <div class="flex flex-col items-center">
                    ...
                    <div class="mt-8 w-full space-y-4">
                        @error('photo')
                            <div class="p-4 rounded-2xl bg-amber-500/10 border border-amber-500/20 text-amber-700 dark:text-amber-400 text-xs font-bold flex items-center gap-3 animate-slideDown">
